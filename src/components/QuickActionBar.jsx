    ...
    <div className="flex items-center justify-start overflow-x-scroll w-full p-2 rounded-xl lg:rounded-2xl bg-white z-30 border border-[#ececec] hide-scrollbar">
      {gridItems.map((item, index) => (
        <button
          ...
          className={`hover:bg-[#dbdbdc] flex items-center justify-center gap-x-2 lg:gap-x-3 text-xs lg:text-sm px-2 py-1 lg:p-8 lg:pl-2 lg:pr-4 lg:py-[0.625rem] rounded-xl transition duration-200 sm:w-full font-extrabold ${
